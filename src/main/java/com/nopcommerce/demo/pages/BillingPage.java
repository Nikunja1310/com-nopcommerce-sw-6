...
public class BillingPage extends Utility {
    ...
    public void selectCountry(String country) {
        ...
        log.info("Select " + country + " from " + countryLink.toString());
    }
    ...
    public void enterPostcode(String postcode) {
        ...
        log.info("Enter " + postcode + postCodeLink.toString());
    }

    public void enterPhoneNumber(String number) {
        sendTextToElement(phoneNumberLink, number);
        log.info("Enter " + number + phoneNumberLink.toString());
    }
    ...
    public void selectPaymentMethod() {
        ...
        log.info("Click on " + paymentMethodLink.toString());
    }
    ...
    public void enterCardHolderName(String name) {
        ...
        log.info("Enter " + name + cardHolderNameLink.toString());
    }

    public void enterCardNumber(String number) {
        sendTextToElement(cardNumberLink, number);
        log.info("Enter " + number + cardNumberLink.toString());
    }

    public void selectExpiryMonth(int month) {
        selectByIndexFromDropDown(cardMonthLink, month);
        log.info("Select " + month + cardMonthLink.toString());
    }
    ...
    public String getHeadText() {
        log.info("Get text " + headText.toString());
    ...
    public void clickOnContinue() {
        ...
        log.info("Click on " + nextStep.toString());
    }
    ...
    public void selectShipping2() {
        ...
        log.info("Click on " + shippingLink2.toString());
    }
}
